...
struct DL_SplineData
{
	...
	unsigned int degree;//样条曲线的阶数

	/*! Number of knots. */
	unsigned int nKnots;//节点数

	/*! Number of control points. */
	unsigned int nControl;//控制点数
...
struct DL_InsertData
{
	...
	int rows;
	/*! Values for the g_iSpacing between cols. */
	double colSp;
	/*! Values for the g_iSpacing between rows. */
	double rowSp;
};
...
struct DL_MTextData
{
	...
	/**
	 * Line g_iSpacing style.
	 *
	 * 1 = at least, 2 = exact
	 */
	int lineSpacingStyle;
	/**
	 * Line g_iSpacing factor. 0.25 .. 4.0
	 */
